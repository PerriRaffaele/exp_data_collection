  ...
  methods: {
    async fetchBoxWords() {
      try {
        ...
        const response = await axios.get('exp-data-collection.vercel.app/exercises');
    ...
    async submitAnswerData() {
      try {
        ...
        const uploadResponse = await axios.post('exp-data-collection.vercel.app/upload-file', formData);
        ...
        const response = await axios.post('exp-data-collection.vercel.app/submit-and-export', answerData);
        ...
        if (this.currentExercise > this.totalExercises) {
          ...
          const exportResponse = await axios.get('exp-data-collection.vercel.app/submit-and-export');
